                        ...
                        <div class="col-xl-12">
                            <div class="row" v-if="order" style="row-gap: 30px;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <UserDropDown :call_back="get_user_info" :name="`customer_id`" :multiple="false" />
                                </div>
                                <div class="col-md-4">
                                    <label>
                                        Select Wearhouse
                                    ...
                                    <ProductWearHuseDropDown :name="`product_wearhouse_id`" :multiple="false" />
                                </div>
                                <div class="col-md-4">
                                    <label>
                                        Date
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="due_date"
                                        :value="new Date().toISOString().substring(0, 10)" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label>
                                        Price Type
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="police_station" :value="user_info.station"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group">
