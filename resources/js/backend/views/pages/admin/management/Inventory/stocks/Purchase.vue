            ...
            <div class="card">
                ...
                <div class="card-body card_body_fixed_height">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="product_wearhouse_id">
                                    Wear House
                                </label>
                                <div class="mt-1 mb-3">
                                    <WearhouseModal :multiple="false" :name="`product_wearhouse_id`" />
                                </div>
                            </div>  
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-1 mb-3">
                                    <input class="form-control form-control-square mb-2" 
                                        type="text" name="bill_receipt_no" id="bill_receipt_no">
                                </div>
                            </div>  
                        </div>
                        <div class="col-md-6">
...
import WearhouseModal from "../wearhouse/components/dropdown/DropDownEl.vue"
